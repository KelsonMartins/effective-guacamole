...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddObjectMapper(this IServiceCollection services, params IMappingProfile[] profiles)
    {
    ...
    public static IServiceCollection AddObjectMapper(this IServiceCollection services, Action<IMappingConfigurationBuilder> configure)
    {
        services.AddSingleton(_ =>
        {
            var builder = new MappingConfigurationBuilder();
    ...
    private static void ConfigureFromAssemblies(MappingConfigurationBuilder builder, Assembly[] assemblies, IServiceProvider sp)
    {
        ...
        foreach (var assembly in toScan)
        {
            ...
            {
                var profile = sp.GetService(profileType) as IMappingProfile
                    ?? (IMappingProfile)ActivatorUtilities.CreateInstance(sp, profileType);
                profile.Configure(builder);
            }
        }
    }
